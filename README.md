...
- create a file called `.env` in the directory where the nodeJS server from this repo is located. Default: `aniwave-discord-presence-server` at the root if the repository 
